...
class ZeroCommerce_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'zero-commerce'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'zero-commerce'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'zero-commerce'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'zero-commerce'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'zero-commerce');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'zero-commerce'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'zero-commerce');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'zero-commerce'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'zero-commerce') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'zero-commerce');
            case 'false':
                return __('false', 'zero-commerce');

            case 'Administrator':
                return __('Administrator', 'zero-commerce');
            case 'Editor':
                return __('Editor', 'zero-commerce');
            case 'Author':
                return __('Author', 'zero-commerce');
            case 'Contributor':
                return __('Contributor', 'zero-commerce');
            case 'Subscriber':
                return __('Subscriber', 'zero-commerce');
            case 'Anyone':
                return __('Anyone', 'zero-commerce');
        }
        return $optionValue;
    }
